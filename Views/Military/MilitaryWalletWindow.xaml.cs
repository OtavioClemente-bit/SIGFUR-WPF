...
public partial class MilitaryWalletWindow : Window
{
    ...
    private async void DownloadPaystub_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Notify("Selecione o ano e o mês do contracheque.");
            return;
        }
        ...
        try
        {
            ...
            else
            {
                ...
                var result = await App.CpexPaystubs.DownloadPaystubForMilitaryAsync(
                    _vm.Military, year, month, openAfterDownload: true, progress: progress);
            ...
            _vm.StatusText = completionMessage;
        }
        catch (Exception ex) { ShowError(ex); }
        finally { _vm.IsBusy = false; }
    }
    ...
    private async void CaptureFinancialStatement_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var result = await App.CpexPaystubs.DownloadLatestFinancialStatementForMilitaryAsync(
                _vm.Military, year, openAfterDownload: true, progress: progress);
            App.Paystubs.InvalidateCache();
