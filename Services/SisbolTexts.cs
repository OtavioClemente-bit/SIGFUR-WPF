...
public static class SisbolTexts
{
    ...
    public static string ToHtml(string text)
    {
        ...
        // Mesmo padrão do corpo da nota: sem font-family e sem font-size.
        // Assim o fechamento herda exatamente a fonte usada pelo SisBol/PDF.
        return $"<div style=\"text-align: justify;\">{encoded}</div>";
    }
}
