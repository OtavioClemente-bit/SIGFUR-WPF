...
public static partial class MilitaryRankService
{
    ...
    [
        ...
        new(7, "Capitão", "Cap", @"\bcapitao\b|\bcap\b", "#DBEAFE"),
        ...
        new(10, "Aspirante", "Asp", @"\baspirante\b|\basp\b", "#E0F2FE"),
        ...
        // A forma genérica vem depois de Subtenente para que "S Ten" não seja
        // reduzido incorretamente a Tenente durante a importação de relações.
        ...
        new(15, "Cabo Efetivo Profissional", "Cb Ef Profl", @"\bcabo efetivo profissional\b|\bcb ef profl\b|\bcb ef prof\b|\bcb ef profissional\b|\bcb profl\b|\bcb profissional\b|\bcb ep\b|\bcabo ep\b|\bcabo profissional\b|\bcabo efetivo variavel\b|\bcb ef vrv\b|\bcb ev\b|\bcabo variavel\b|(?:^|\s)(?:cabo|cb)(?:$|\s)", "#EDE9FE"),
        ...
        new(17, "Soldado Efetivo Variável", "Sd Ef Vrv", @"\bsoldado efetivo variavel\b|\bsd ef vrv\b|\bsd ev\b|\bsd variavel\b|\bsoldado recruta\b|\bsd rcr\b|\brecruta\b", "#E2E8F0")
    ];
    ...
    [
        ...
        "#FFEDD5", "#CCFBF1", "#C7D2FE", "#F3E8FF", "#ECFCCB",
        "#FDE68A", "#BFDBFE", "#BBF7D0", "#FBCFE8", "#DDD6FE",
        "#FED7AA", "#A7F3D0", "#BAE6FD", "#E9D5FF", "#D9F99D"
    ];
    ...
    public static string GetColorDescription(string? rank, string? formationYear)
    {
        ...
        if (GetOrder(rank) == 16 && !string.IsNullOrWhiteSpace(formationYear))
