...
public static class ActionCatalog
{
    public static List<ActionDefinition> Create(Dictionary<string, string>? hotkeys = null)
    {
        ...
        [
            ...
            A("plano_chamada", "Plano de Chamada", "📞", "Atualiza pela relação, padroniza contatos e confere Carteira/Auxílio-Transporte sem sobrescrever dados", "Cadastros e Boletins", native: true),
            ...
            A("boletim_furriel", "Aditamento Furriel", "📘", "Biblioteca, indexação e pesquisa profissional dos aditamentos do furriel", "Cadastros e Boletins", native: true),
            ...
            A("bizurometro_sped", "SPED Processos", "🧭", "Preparar DIEx, anexos, processo, conferência e despacho", "Financeiro", H("bizurometro_sped"), true),
            ...
            A("conferencia_sippes", "Conferir Efetivo SIPPES", "🧾", "Ler Dados de Militar da Ativa e cruzar com Ativos + Licenciados/Transferidos", "Financeiro", native: true),
            A("auditoria_contracheques", "Auditoria dos Contracheques", "🔎", "Auditar rubricas, FUSEx, auxílio-transporte, banco e situação dos contracheques", "Financeiro", native: true),
