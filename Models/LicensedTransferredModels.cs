...
public sealed class LicensedTransferredRecord : INotifyPropertyChanged
{
    ...
    private string _savedPaystubsText = "Verificando...";
    public string SavedPaystubsText
    {
        get => _savedPaystubsText;
        set
        {
            if (_savedPaystubsText == value) return;
            _savedPaystubsText = value;
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(SavedPaystubsText)));
        }
    }
