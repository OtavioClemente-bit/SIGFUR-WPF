...
public sealed class AssistantSettings
{
    ...
    public bool UseTls12Compatibility { get; set; }
    ...
    public bool EnableOfficialWebResearch { get; set; } = true;
    public int MaxToolRounds { get; set; } = 8;
    public int MaxContextCharacters { get; set; } = 60_000;
    public bool EnableDeadlineNotifications { get; set; } = true;
...
public sealed class AssistantConversationMessage
{
    ...
    public string RoleLabel => Role.Equals("user", StringComparison.OrdinalIgnoreCase) ? "VOCÊ" : "SIGFUR IA";
...
public sealed class AssistantUsageRecord
{
    ...
    public int OutputTokens { get; set; }
    public decimal PaidToolsCostUsd { get; set; }
...
public sealed class AssistantPendingAction
{
    ...
    public bool IsConversationLink => Type.Equals("open_file", StringComparison.OrdinalIgnoreCase)
                                      || Type.Equals("create_reminder", StringComparison.OrdinalIgnoreCase)
    ...
    [JsonIgnore]
    public string PrimaryButtonLabel => Type.Equals("create_reminder", StringComparison.OrdinalIgnoreCase) ? "Revisar e salvar" : Type.Equals("copy_text", StringComparison.OrdinalIgnoreCase)
        ? "Copiar"
