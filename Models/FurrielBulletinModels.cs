...
public sealed class FurrielModuleSettings
{
    ...
    [JsonPropertyName("indice_assunto_data_inicial_boletim_furriel")]
    public DateTime? SubjectIndexStartDate { get; set; }

    [JsonPropertyName("indice_assunto_data_final_boletim_furriel")]
    public DateTime? SubjectIndexEndDate { get; set; }
